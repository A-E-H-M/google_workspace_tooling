...
const folderId = 'YOUR_GOOGLE_FOLDER_ID';
...
async function convertPDFToPNG_(pdfFileId, folderId) {
  ...
  for (let i = 0; i < pageLength; i++) {
    ...
    const newFileName = 'YOUR_BEGINNING_FILE_NAME' + folderName + '_' + char + '.png';
    ...
    //var char = 65 + i;
    destinationFolder.createFile(jpgBlob).setName('YOUR_BEGINNING_FILE_NAME' + folderName + '_' + char + '.jpg');
  ...
  pdf.moveTo(DriveApp.getFolderById('YOUR_GOOGLE_FOLDER_ID'));
}
